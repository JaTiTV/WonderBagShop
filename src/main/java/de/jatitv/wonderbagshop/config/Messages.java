...
public class Messages {
    ...
    public static String NoPermission = "[prefix] §cFür §b[command] §cfehlt dir die Permission §6[permission]§c!";
    public static String ReloadStart = "§6Plugin reload...";
    public static String ReloadEnd = "§2Plugin successfully reloaded.";
    public static String VaultNotSetUp = "§4Vault / Economy not set up!";
    public static String Help = "[prefix]§8------ §2Wonder§6Bag§9Shop §chelp §8------\n[prefix]\n[prefix]'§b/wonderbagshop§e' [OE]ffnet diese help.\n[prefix]'§b/wonderbagshop shop§e' [OE]ffnet den Shop.\n[prefix]'§b/wonderbagshop reload§e' L[ae]d die Cofig neu.\n[prefix]\n[prefix]§8----------------------------";
    public static String No_money = "§8[§2Wonder§6Bag§9Shop§8] §cDu hast nicht genügend Geld";

    public static void messagesCreate(){

        Bukkit.getConsoleSender().sendMessage(Messages.Prefix + "§4Messages load...");
        ...
        if (yamlConfiguration_msg.contains("Plugin.Prefix")) {
            Prefix = replace(yamlConfiguration_msg.getString("Plugin.Prefix"));
        } else {
            yamlConfiguration_msg.set("Plugin.Prefix", "&8[&2Wonder&6Bag&9Shop&8] ");
            Bukkit.getConsoleSender().sendMessage(Messages.Prefix + "§4Message §6Prefix §4was added to §9messages.yml§4!");
        }
        ...
        if (yamlConfiguration_msg.contains("Plugin.NoPermission")) {
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.Prefix + "§4Message §6NoPermission §4was added to §9messages.yml§4!");
        }
        ...
        if (yamlConfiguration_msg.contains("Plugin.Reload.Start")) {
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.Prefix + "§4Message §6Reload Start §4was added to §9messages.yml§4!");
        }
        if (yamlConfiguration_msg.contains("Plugin.Reload.End")) {
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.Prefix + "§4Message §6Reload End §4was added to §9messages.yml§4!");
        }
        ...
        if (yamlConfiguration_msg.contains("Plugin.VaultNotSetUp")) {
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.Prefix + "§4Message §6VaultNotSetUp §4was added to §9messages.yml§4!");
        }
        ...
        if (yamlConfiguration_msg.contains("Help")) {
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.Prefix + "§4Message §6Help §4was added to §9messages.yml§4!");
        }
        ...
        if(yamlConfiguration_msg.contains("Shop.No_money")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.Prefix + "§4Shop Setting §6No_money §4was added to §9messages.yml§4!");
        }
        ...
        Bukkit.getConsoleSender().sendMessage(Messages.Prefix + "§2Messages loaded successfully.");
    }
