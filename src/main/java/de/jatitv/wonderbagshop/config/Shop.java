...
public class Shop {
    ...
    public static void shopCreate(){
        ...
        if(yamlConfiguration_shop.contains("ShopName")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6ShopName §4was added to §9messages.yml§4!");
        }
        ...
        if(yamlConfiguration_shop.contains("WonderBag.WonderBag_1.Name")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6WonderBag Item_1 Name §4was added to §9messages.yml§4!");
        }
        ...
        if(yamlConfiguration_shop.contains("WonderBag.WonderBag_1.ChestName")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6WonderBag/WonderBag_1/ChestName §4was added to §9messages.yml§4!");
        }
        ...
        if(yamlConfiguration_shop.contains("WonderBag.WonderBag_1.Items")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6WonderBag Item_1 Items §4was added to §9messages.yml§4!");
        }
        ...
        if(yamlConfiguration_shop.contains("WonderBag.WonderBag_1.price")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6WonderBag Item_1 price §4was added to §9messages.yml§4!");
        }
        ...
        if(yamlConfiguration_shop.contains("WonderBag.WonderBag_1.buy_msg")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6WonderBag Item_1 buy_msg §4was added to §9messages.yml§4!");
        }
        ...
        if(yamlConfiguration_shop.contains("WonderBag.WonderBag_2.Name")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6WonderBag WonderBag_2 Name §4was added to §9messages.yml§4!");
        }
        ...
        if(yamlConfiguration_shop.contains("WonderBag.WonderBag_2.ChestName")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6WonderBag/WonderBag_2/ChestName §4was added to §9messages.yml§4!");
        }
        ...
        if(yamlConfiguration_shop.contains("WonderBag.WonderBag_2.Items")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6WonderBag Item_2 Items §4was added to §9messages.yml§4!");
        }
        ...
        if(yamlConfiguration_shop.contains("WonderBag.WonderBag_2.price")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6WonderBag Item_2 price §4was added to §9messages.yml§4!");
        }

        if(yamlConfiguration_shop.contains("WonderBag.WonderBag_2.buy_msg")){
            WB2buy_msg = replace(yamlConfiguration_shop.getString("WonderBag.WonderBag_2.buy_msg"));
        }else{
            yamlConfiguration_shop.set("WonderBag.WonderBag_2.buy_msg", "[prefix]&2Du hast dir [WB2Name] §2für [WB2Price] $ §2gekauft!");
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6WonderBag Item_2 buy_msg §4was added to §9messages.yml§4!");
        }
        ...
        if(yamlConfiguration_shop.contains("WonderBag.WonderBag_3.Name")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6WonderBag Item_3 Name §4was added to §9messages.yml§4!");
        }
        ...
        if(yamlConfiguration_shop.contains("WonderBag.WonderBag_3.ChestName")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6WonderBag/WonderBag_3/ChestName §4was added to §9messages.yml§4!");
        }
        ...
        if(yamlConfiguration_shop.contains("WonderBag.WonderBag_3.Items")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6WonderBag Item_3 Items §4was added to §9messages.yml§4!");
        }
        ...
        if(yamlConfiguration_shop.contains("WonderBag.WonderBag_3.price")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6WonderBag Item_3 price §4was added to §9messages.yml§4!");
        }
        ...
        if(yamlConfiguration_shop.contains("WonderBag.WonderBag_3.buy_msg")){
            ...
            Bukkit.getConsoleSender().sendMessage(Messages.PrefixHC + "§4Shop Setting §6WonderBag Item_3 buy_msg §4was added to §9messages.yml§4!");
        }
    ...
    private static String replace(String Text) {
        return Text.replace("[prefix]", Messages.Prefix).replace("[currency]", Config.Currency).replace("&", "§").replace("[WB1Name]", WB1Name).replace("[WB2Name]", WB2Name).replace("[WB3Name]", WB3Name).replace("[ue]", "ü").replace("[UE]", "Ü").replace("[oe]", "Ö").replace("[OE]", "Ö").replace("[ae]", "Ä").replace("[AE]", "Ä");
    }
