...
public class WonderBagChest_1 {
    ...
    public static void WB1ChestCreate() throws InterruptedException {
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item2.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item2 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item3.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item3 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item4.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item4 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item5.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item5 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item6.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item6 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item7.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item7 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item8.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item8 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item9.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item9 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item10.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item10 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item11.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item11 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item12.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item12 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item13.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item13 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item14.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item14 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item15.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item15 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item16.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item16 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item17.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item17 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item18.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item18 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item19.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item19 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item20.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item20 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item21.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item21 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item22.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item22 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item23.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item23 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item24.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item24 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item25.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item25 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item26.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item26 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item27.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item27 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item28.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item28 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item29.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item29 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item30.StackSize_(1-64)")) {
            ...
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item30 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item31.StackSize_(1-64)")) {
            DefultValueChest_1.Item31_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item31.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item31.StackSize_(1-64)", DefultValueChest_1.Item31_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item31 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item32.StackSize_(1-64)")) {
            DefultValueChest_1.Item32_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item32.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item32.StackSize_(1-64)", DefultValueChest_1.Item32_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item32 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item33.StackSize_(1-64)")) {
            DefultValueChest_1.Item33_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item33.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item33.StackSize_(1-64)", DefultValueChest_1.Item33_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item33 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item34.StackSize_(1-64)")) {
            DefultValueChest_1.Item34_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item34.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item34.StackSize_(1-64)", DefultValueChest_1.Item34_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item34 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item35.StackSize_(1-64)")) {
            DefultValueChest_1.Item35_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item35.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item35.StackSize_(1-64)", DefultValueChest_1.Item35_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item35 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item36.StackSize_(1-64)")) {
            DefultValueChest_1.Item36_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item36.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item36.StackSize_(1-64)", DefultValueChest_1.Item36_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item36 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item37.StackSize_(1-64)")) {
            DefultValueChest_1.Item37_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item37.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item37.StackSize_(1-64)", DefultValueChest_1.Item37_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item37 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item38.StackSize_(1-64)")) {
            DefultValueChest_1.Item38_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item38.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item38.StackSize_(1-64)", DefultValueChest_1.Item38_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item38 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item39.StackSize_(1-64)")) {
            DefultValueChest_1.Item39_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item39.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item39.StackSize_(1-64)", DefultValueChest_1.Item39_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item39 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item40.StackSize_(1-64)")) {
            DefultValueChest_1.Item40_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item40.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item40.StackSize_(1-64)", DefultValueChest_1.Item40_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item40 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item41.StackSize_(1-64)")) {
            DefultValueChest_1.Item41_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item41.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item41.StackSize_(1-64)", DefultValueChest_1.Item1_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item41 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item42.StackSize_(1-64)")) {
            DefultValueChest_1.Item42_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item42.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item42.StackSize_(1-64)", DefultValueChest_1.Item42_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item42 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item43.StackSize_(1-64)")) {
            DefultValueChest_1.Item43_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item43.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item43.StackSize_(1-64)", DefultValueChest_1.Item43_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item43 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item44.StackSize_(1-64)")) {
            DefultValueChest_1.Item44_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item44.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item44.StackSize_(1-64)", DefultValueChest_1.Item44_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item44 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item45.StackSize_(1-64)")) {
            DefultValueChest_1.Item45_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item45.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item45.StackSize_(1-64)", DefultValueChest_1.Item45_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item45 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item46.StackSize_(1-64)")) {
            DefultValueChest_1.Item46_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item46.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item46.StackSize_(1-64)", DefultValueChest_1.Item46_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item46 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item47.StackSize_(1-64)")) {
            DefultValueChest_1.Item7_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item47.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item47.StackSize_(1-64)", DefultValueChest_1.Item47_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item47 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item48.StackSize_(1-64)")) {
            DefultValueChest_1.Item48_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item48.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item48.StackSize_(1-64)", DefultValueChest_1.Item48_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item48 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item49.StackSize_(1-64)")) {
            DefultValueChest_1.Item49_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item49.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item49.StackSize_(1-64)", DefultValueChest_1.Item49_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item49 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item50.StackSize_(1-64)")) {
            DefultValueChest_1.Item50_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item50.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item50.StackSize_(1-64)", DefultValueChest_1.Item50_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item50 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item51.StackSize_(1-64)")) {
            DefultValueChest_1.Item51_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item51.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item51.StackSize_(1-64)", DefultValueChest_1.Item51_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item51 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item52.StackSize_(1-64)")) {
            DefultValueChest_1.Item52_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item52.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item52.StackSize_(1-64)", DefultValueChest_1.Item52_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item52 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item53.StackSize_(1-64)")) {
            DefultValueChest_1.Item53_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item53.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item53.StackSize_(1-64)", DefultValueChest_1.Item53_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item53 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item54.StackSize_(1-64)")) {
            DefultValueChest_1.Item54_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item54.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item54.StackSize_(1-64)", DefultValueChest_1.Item54_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item54 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item55.StackSize_(1-64)")) {
            DefultValueChest_1.Item55_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item55.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item55.StackSize_(1-64)", DefultValueChest_1.Item55_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item55 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item56.StackSize_(1-64)")) {
            DefultValueChest_1.Item56_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item56.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item56.StackSize_(1-64)", DefultValueChest_1.Item56_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item56 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item57.StackSize_(1-64)")) {
            DefultValueChest_1.Item57_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item57.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item57.StackSize_(1-64)", DefultValueChest_1.Item57_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item57 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item58.StackSize_(1-64)")) {
            DefultValueChest_1.Item58_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item58.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item58.StackSize_(1-64)", DefultValueChest_1.Item58_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item58 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item59.StackSize_(1-64)")) {
            DefultValueChest_1.Item9_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item59.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item59.StackSize_(1-64)", DefultValueChest_1.Item59_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item59 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item60.StackSize_(1-64)")) {
            DefultValueChest_1.Item60_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item60.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item60.StackSize_(1-64)", DefultValueChest_1.Item60_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item60 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item61.StackSize_(1-64)")) {
            DefultValueChest_1.Item61_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item61.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item61.StackSize_(1-64)", DefultValueChest_1.Item61_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item61 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item62.StackSize_(1-64)")) {
            DefultValueChest_1.Item62_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item62.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item62.StackSize_(1-64)", DefultValueChest_1.Item62_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item62 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item63.StackSize_(1-64)")) {
            DefultValueChest_1.Item63_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item63.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item63.StackSize_(1-64)", DefultValueChest_1.Item63_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item63 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item64.StackSize_(1-64)")) {
            DefultValueChest_1.Item64_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item64.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item64.StackSize_(1-64)", DefultValueChest_1.Item64_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item64 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item65.StackSize_(1-64)")) {
            DefultValueChest_1.Item65_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item65.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item65.StackSize_(1-64)", DefultValueChest_1.Item65_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item65 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item66.StackSize_(1-64)")) {
            DefultValueChest_1.Item66_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item66.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item66.StackSize_(1-64)", DefultValueChest_1.Item66_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item66 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item67.StackSize_(1-64)")) {
            DefultValueChest_1.Item67_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item67.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item67.StackSize_(1-64)", DefultValueChest_1.Item67_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item67 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item68.StackSize_(1-64)")) {
            DefultValueChest_1.Item68_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item68.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item68.StackSize_(1-64)", DefultValueChest_1.Item68_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item68 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item69.StackSize_(1-64)")) {
            DefultValueChest_1.Item69_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item69.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item69.StackSize_(1-64)", DefultValueChest_1.Item69_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item69 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
        ...
        if (yamlConfiguration_WB1_Chest.contains("Item70.StackSize_(1-64)")) {
            DefultValueChest_1.Item70_StackSize = Integer.valueOf(yamlConfiguration_WB1_Chest.getString("Item70.StackSize_(1-64)"));
        } else {
            yamlConfiguration_WB1_Chest.set("Item70.StackSize_(1-64)", DefultValueChest_1.Item70_StackSize);
            Bukkit.getConsoleSender().sendMessage(DefultValue.PrefixHC + "§4Setting §6Item70 StackSize_(1-64) §4was added to §9WonderBag Chest small.yml§4!");
        }
