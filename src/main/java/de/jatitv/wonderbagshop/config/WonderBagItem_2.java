...
public class WonderBagItem_2 {
    ...
    public static void WB2ItemCreate() throws InterruptedException {
        ...
        if (yamlConfiguration_WB2_Item.contains("Shop.price")) {
            DefultValueItem_2.price = Double.valueOf(yamlConfiguration_WB2_Item.getString("Shop.price"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("WonderBag.Item")) {
            DefultValueItem_2.Item = replace(yamlConfiguration_WB2_Item.getString("WonderBag.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item1.Item")) {
            DefultValueItem_2.Item1_Item = (yamlConfiguration_WB2_Item.getString("Item1.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item2.Item")) {
            DefultValueItem_2.Item2_Item = (yamlConfiguration_WB2_Item.getString("Item2.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item3.Item")) {
            DefultValueItem_2.Item3_Item = (yamlConfiguration_WB2_Item.getString("Item3.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item4.Item")) {
            DefultValueItem_2.Item4_Item = (yamlConfiguration_WB2_Item.getString("Item4.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item5.Item")) {
            DefultValueItem_2.Item5_Item = (yamlConfiguration_WB2_Item.getString("Item5.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item6.Item")) {
            DefultValueItem_2.Item6_Item = (yamlConfiguration_WB2_Item.getString("Item6.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item7.Item")) {
            DefultValueItem_2.Item7_Item = (yamlConfiguration_WB2_Item.getString("Item7.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item8.Item")) {
            DefultValueItem_2.Item8_Item = (yamlConfiguration_WB2_Item.getString("Item8.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item9.Item")) {
            DefultValueItem_2.Item9_Item = (yamlConfiguration_WB2_Item.getString("Item9.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item10.Item")) {
            DefultValueItem_2.Item10_Item = (yamlConfiguration_WB2_Item.getString("Item10.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item11.Item")) {
            DefultValueItem_2.Item11_Item = (yamlConfiguration_WB2_Item.getString("Item11.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item12.Item")) {
            DefultValueItem_2.Item12_Item = (yamlConfiguration_WB2_Item.getString("Item12.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item13.Item")) {
            DefultValueItem_2.Item13_Item = (yamlConfiguration_WB2_Item.getString("Item13.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item14.Item")) {
            DefultValueItem_2.Item14_Item = (yamlConfiguration_WB2_Item.getString("Item14.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item15.Item")) {
            DefultValueItem_2.Item15_Item = (yamlConfiguration_WB2_Item.getString("Item15.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item16.Item")) {
            DefultValueItem_2.Item16_Item = (yamlConfiguration_WB2_Item.getString("Item16.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item17.Item")) {
            DefultValueItem_2.Item17_Item = (yamlConfiguration_WB2_Item.getString("Item17.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item18.Item")) {
            DefultValueItem_2.Item18_Item = (yamlConfiguration_WB2_Item.getString("Item18.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item19.Item")) {
            DefultValueItem_2.Item19_Item = (yamlConfiguration_WB2_Item.getString("Item19.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item20.Item")) {
            DefultValueItem_2.Item20_Item = (yamlConfiguration_WB2_Item.getString("Item20.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item21.Item")) {
            DefultValueItem_2.Item21_Item = (yamlConfiguration_WB2_Item.getString("Item21.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item22.Item")) {
            DefultValueItem_2.Item22_Item = (yamlConfiguration_WB2_Item.getString("Item22.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item23.Item")) {
            DefultValueItem_2.Item23_Item = (yamlConfiguration_WB2_Item.getString("Item23.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item24.Item")) {
            DefultValueItem_2.Item24_Item = (yamlConfiguration_WB2_Item.getString("Item24.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item25.Item")) {
            DefultValueItem_2.Item25_Item = (yamlConfiguration_WB2_Item.getString("Item25.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item26.Item")) {
            DefultValueItem_2.Item26_Item = (yamlConfiguration_WB2_Item.getString("Item26.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item27.Item")) {
            DefultValueItem_2.Item27_Item = (yamlConfiguration_WB2_Item.getString("Item27.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item28.Item")) {
            DefultValueItem_2.Item28_Item = (yamlConfiguration_WB2_Item.getString("Item28.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item29.Item")) {
            DefultValueItem_2.Item29_Item = (yamlConfiguration_WB2_Item.getString("Item29.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item30.Item")) {
            DefultValueItem_2.Item30_Item = (yamlConfiguration_WB2_Item.getString("Item30.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item31.Item")) {
            DefultValueItem_2.Item31_Item = (yamlConfiguration_WB2_Item.getString("Item31.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item32.Item")) {
            DefultValueItem_2.Item32_Item = (yamlConfiguration_WB2_Item.getString("Item32.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item33.Item")) {
            DefultValueItem_2.Item33_Item = (yamlConfiguration_WB2_Item.getString("Item33.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item34.Item")) {
            DefultValueItem_2.Item34_Item = (yamlConfiguration_WB2_Item.getString("Item34.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item35.Item")) {
            DefultValueItem_2.Item35_Item = (yamlConfiguration_WB2_Item.getString("Item35.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item36.Item")) {
            DefultValueItem_2.Item36_Item = (yamlConfiguration_WB2_Item.getString("Item36.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item37.Item")) {
            DefultValueItem_2.Item37_Item = (yamlConfiguration_WB2_Item.getString("Item37.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item38.Item")) {
            DefultValueItem_2.Item38_Item = (yamlConfiguration_WB2_Item.getString("Item38.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item39.Item")) {
            DefultValueItem_2.Item39_Item = (yamlConfiguration_WB2_Item.getString("Item39.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item40.Item")) {
            DefultValueItem_2.Item40_Item = (yamlConfiguration_WB2_Item.getString("Item40.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item41.Item")) {
            DefultValueItem_2.Item41_Item = (yamlConfiguration_WB2_Item.getString("Item41.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item42.Item")) {
            DefultValueItem_2.Item42_Item = (yamlConfiguration_WB2_Item.getString("Item42.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item43.Item")) {
            DefultValueItem_2.Item43_Item = (yamlConfiguration_WB2_Item.getString("Item43.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item44.Item")) {
            DefultValueItem_2.Item44_Item = (yamlConfiguration_WB2_Item.getString("Item44.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item45.Item")) {
            DefultValueItem_2.Item45_Item = (yamlConfiguration_WB2_Item.getString("Item45.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item46.Item")) {
            DefultValueItem_2.Item46_Item = (yamlConfiguration_WB2_Item.getString("Item46.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item47.Item")) {
            DefultValueItem_2.Item47_Item = (yamlConfiguration_WB2_Item.getString("Item47.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item48.Item")) {
            DefultValueItem_2.Item48_Item = (yamlConfiguration_WB2_Item.getString("Item48.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item49.Item")) {
            DefultValueItem_2.Item49_Item = (yamlConfiguration_WB2_Item.getString("Item49.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item50.Item")) {
            DefultValueItem_2.Item50_Item = (yamlConfiguration_WB2_Item.getString("Item50.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item51.Item")) {
            DefultValueItem_2.Item51_Item = (yamlConfiguration_WB2_Item.getString("Item51.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item52.Item")) {
            DefultValueItem_2.Item52_Item = (yamlConfiguration_WB2_Item.getString("Item52.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item53.Item")) {
            DefultValueItem_2.Item53_Item = (yamlConfiguration_WB2_Item.getString("Item53.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item54.Item")) {
            DefultValueItem_2.Item54_Item = (yamlConfiguration_WB2_Item.getString("Item54.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item55.Item")) {
            DefultValueItem_2.Item55_Item = (yamlConfiguration_WB2_Item.getString("Item55.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item56.Item")) {
            DefultValueItem_2.Item56_Item = (yamlConfiguration_WB2_Item.getString("Item56.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item57.Item")) {
            DefultValueItem_2.Item57_Item = (yamlConfiguration_WB2_Item.getString("Item57.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item58.Item")) {
            DefultValueItem_2.Item58_Item = (yamlConfiguration_WB2_Item.getString("Item58.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item59.Item")) {
            DefultValueItem_2.Item59_Item = (yamlConfiguration_WB2_Item.getString("Item59.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item60.Item")) {
            DefultValueItem_2.Item60_Item = (yamlConfiguration_WB2_Item.getString("Item60.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item61.Item")) {
            DefultValueItem_2.Item61_Item = (yamlConfiguration_WB2_Item.getString("Item61.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item62.Item")) {
            DefultValueItem_2.Item62_Item = (yamlConfiguration_WB2_Item.getString("Item62.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item63.Item")) {
            DefultValueItem_2.Item63_Item = (yamlConfiguration_WB2_Item.getString("Item63.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item64.Item")) {
            DefultValueItem_2.Item64_Item = (yamlConfiguration_WB2_Item.getString("Item64.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item65.Item")) {
            DefultValueItem_2.Item65_Item = (yamlConfiguration_WB2_Item.getString("Item65.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item66.Item")) {
            DefultValueItem_2.Item66_Item = (yamlConfiguration_WB2_Item.getString("Item66.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item67.Item")) {
            DefultValueItem_2.Item67_Item = (yamlConfiguration_WB2_Item.getString("Item67.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item68.Item")) {
            DefultValueItem_2.Item68_Item = (yamlConfiguration_WB2_Item.getString("Item68.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item69.Item")) {
            DefultValueItem_2.Item69_Item = (yamlConfiguration_WB2_Item.getString("Item69.Item").toUpperCase().replace(".", "_"));
        } else {
        ...
        if (yamlConfiguration_WB2_Item.contains("Item70.Item")) {
            DefultValueItem_2.Item70_Item = (yamlConfiguration_WB2_Item.getString("Item70.Item").toUpperCase().replace(".", "_"));
        } else {
